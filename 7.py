...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def initUI(self):
        ...
        self.checkBox_1.clicked.connect(self.addOne)
        self.checkBox_2.clicked.connect(self.addOne)
        self.checkBox_3.clicked.connect(self.addOne)
        self.checkBox_4.clicked.connect(self.addOne)
